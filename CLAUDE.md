...
> Auto-generated by init on 2026-04-11. Based on:
> - Codebase scan of this repository (41 .md files, 7 scripts/configs, ~3500 lines)
> - Manifest v4.1.1, plugin.json v4.1.1
>
...
- **Target audience:** .NET fintech teams using Claude Code
...
- `.claude/references/coding-guidelines.md` — Moberg C# coding style guide
- `.claude/references/security-checklist.md` — Security checklist for fintech changes
- `.claude/references/testing-patterns.md` — Testing guidance for .NET projects
- `.claude/references/performance-checklist.md` — Performance checklist for services
- `.claude/references/ef-core-checklist.md` — EF Core review checklist
- `.claude/references/mediatr-slice-patterns.md` — MediatR/CQRS slice conventions

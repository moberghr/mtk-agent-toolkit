...
Two low-friction token/context wins, drawn from a survey of context-saving tooling against MTK's existing machinery (output compression, on-demand loading, model routing were already covered).
